$(function () {
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Prefecture", field: "prefecture_id", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "City", field: "city", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Local", field: "local", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Street Address", field: "street_address", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Bussines Hour", field: "business_hour", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Regular Holiday", field: "regular_holiday", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Phone", field: "phone", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Fax", field: "fax", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "URL", field: "url", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "License Number", field: "license_number", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},    
